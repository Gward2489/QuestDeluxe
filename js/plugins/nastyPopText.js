...
Sprite_Character.prototype.start_namepop = function(){
    ...
    var b_width = (this.namepop.length * (19/2) + 66) + this.char.namepop_width;
    var b_height = (19 + 28) + this.char.namepop_height;
    var x = ((0 - b_width/2) + this.char.namepop_ox);
    var y = (0 - b_height - 35) - this.char.namepop_oy;
    ...
    this.namepop_sprite.contents.textColor = "#ffffff";
    this.namepop_sprite.contents.outlineColor = "rgbs(0, 0, 0, .5)";
    this.namepop_sprite.contents.outlineWidth = 2.3;
    this.namepop_sprite.contents.fontSize = 21.3;
    ...
    this.namepop_sprite.drawTextEx("\\I[172] "+this.namepop, 0, 0);

    this.text_timer = this.char.namepop_time;
    this.namepop_time = this.char.namepop_time;
    this.namepop_sprite.visible = true;
    console.log(this)
    console.log(this.namepop)
    console.log(this.namepop_sprite)
    console.log(this.char)
    this.addChild(this.namepop_sprite);
    // this.namepop_sprite.open();
    // this.namepop_sprite.drawIcon(164, x + 2, y + 2);
    // this.namepop_sprite.drawText(this.namepop, x, y, b_width);
};
...
var Nasty_txtpop_standardpadding_alias = Window_Base.prototype.standardPadding;
  ...
  Window_CharacterPop.prototype.processDrawIcon = function(iconIndex, textState) {
    this.drawIcon(iconIndex, textState.x + 2, textState.y + 2);
    textState.x += Window_Base._iconWidth - 14;
    textState.y -= 2;
};
